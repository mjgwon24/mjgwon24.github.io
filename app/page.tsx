      ...
      >
        <main className="flex flex-col row-start-2 items-center"
          ...
          <div className="flex flex-col gap-6 items-center">
            ...
            <h1 className="text-3xl sm:text-4xl weight-700 text-center leading-snug">
              개발을 사랑하는 개발자,<br/>
          ...
          <div className="flex flex-col gap-5 items-center">
            <div className="flex flex-col gap-2 sm:gap-3 items-center">
              <h2 className="text-2xl sm:text-3xl weight-700 pr-1">
                🚀 기술 스택
              </h2>

              <p className="sm:text-xl weight-500 pl-3">이런 기술을 사용해 개발해왔습니다.</p>
            </div>
          ...
          <div className="flex flex-col gap-5 items-center">
            <div className="flex flex-col gap-2 sm:gap-3 items-center">
              ...
              <p className="sm:text-xl weight-500 pl-3">제작한 프로젝트들, 어떤게 있을까요?</p>
            </div>
